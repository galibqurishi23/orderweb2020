                ...
                <div className="mb-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
                        {getFilteredItems().map((item) => (
                            <Card 
                                key={item.id} 
                                className="group overflow-hidden backdrop-blur-xl border-0 shadow-2xl hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-2"
                                    style={{
                                        background: `linear-gradient(135deg, rgba(255,255,255,0.95) 0%, rgba(255,255,255,0.85) 100%)`,
                                        backdropFilter: 'blur(20px)',
                                ...
                                >
                                    {item.image_url ? (
                                        ...
                                        >
                                            <Package className="w-16 h-16 text-white z-10" />
                                            <div className="absolute inset-0 bg-gradient-to-br from-white/20 to-transparent"></div>
                                    ...
                                    {item.is_featured && (
                                        <div className="absolute top-4 left-4">
                                            <Badge 
                                                className="text-white border-none shadow-xl font-bold tracking-wide"
                                                style={{
                                                    background: `linear-gradient(135deg, rgb(255, 165, 0) 0%, rgb(255, 140, 0) 100%)`,
                                                    boxShadow: '0 8px 25px rgba(255, 165, 0, 0.4), 0 4px 12px rgba(255, 140, 0, 0.3)'
                                                }}
                                            >
                                                ⭐ Featured
                                            </Badge>
                                    ...
                                    <Button
                                        variant="ghost"
                                        size="sm"
                                        className="absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-500 bg-white/90 backdrop-blur-sm shadow-xl border-0 hover:shadow-2xl"
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="relative">
                                    {selectedItem.image_url ? (
                                        ...
                                        <div 
                                            className="w-full h-80 rounded-2xl flex items-center justify-center relative overflow-hidden shadow-2xl"
                                            style={{
                                                background: `linear-gradient(135deg, rgb(63, 75, 248) 0%, rgb(139, 92, 246) 100%)`,
                                ...
                                <div className="space-y-6">
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <Badge 
                                                className="bg-gray-100 text-gray-700 border-0 font-semibold px-4 py-2"
                                            >
